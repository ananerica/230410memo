...
export default function Main() {
  return (
    <>
      <nav class="bg-yellow border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
          ...
          <div class="flex items-center lg:order-2">
            <a
              ...
              class="text-gray-800 dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium 
                  rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none 
            ...
            <a
              ...
              class="text-white bg-primary-700 hover:bg-primary-800 focus:ring-4 focus:ring-primary-300 font-medium 
                rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:bg-primary-600 dark:hover:bg-primary-700 focus:outline-none 
